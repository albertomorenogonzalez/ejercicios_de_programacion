...
/**
 * Programa que devuelve la media del array que se pasa como parámetro.
 *
 * @author Alberto Moreno Gonzalez
 */
public class Tema08Ejercicio23AlbertoM { 
  public static void main(String[] args) {
    ...
    System.out.println("La media del array es " + funciones.funcionesTema802.mediaArrayInt(array));
  }
}