...
/**
 * Programa que rota n posiciones a la izquierda los números de un array.
 *
 * @author Alberto Moreno Gonzalez
 */
public class Tema08Ejercicio28AlbertoM { 
  public static void main(String[] args) {
    Scanner s = new Scanner(System.in); //declaramos la variable para usar la clase Scanner

    System.out.println("PROGRAMA QUE ROTA N POSICIONES A LA IZQUIERDA LOS NÚMEROS DE UN ARRAY");
    System.out.println("----------------------------------------------------------------------");
    System.out.println(" ");
    ...
    System.out.println("Introduzca el número de posiciones a la izquierda que quiere que rote el array: ");
    System.out.print("> ");
    ...
    funciones.funcionesTema802.muestraArray(funciones.funcionesTema802.rotaIzquierdaArrayInt(array, posiciones), tamañoArray); 
  }
}