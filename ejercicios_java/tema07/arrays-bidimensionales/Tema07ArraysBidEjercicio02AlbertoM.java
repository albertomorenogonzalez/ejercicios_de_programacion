 ...
 */
public class Tema07ArraysBidEjercicio02AlbertoM { 
  public static void main(String[] args) {
    System.out.println("PROGRAMA QUE PIDE 20 NÚMEROS ENTEROS, LOS MUESTRA EN UNA TABLA DE 4 FILAS Y 5 COLUMNAS Y MUESTRA LAS SUMAS DE LAS FILAS, DE LAS COLUMNA, Y LA TOTAL");
    System.out.println("----------------------------------------------------------------------------------------------------------------------------------------------------");
    System.out.println(" ");
